...
#define E1701_LASERMODE_MOPA    (8|E1701_LASER_FREQ_ON1|E1701_LASER_FREQ_OFF)
#define E1701_LASERMODE_IPG     E1701_LASERMODE_MOPA // deprecated, use E1701_LASERMODE_MOPA instead

#define E1701_CSTATE_MARKING              0x000001
#define E1701_CSTATE_START_PRESSED        0x000002
#define E1701_CSTATE_STOP_PRESSED         0x000004
#define E1701_CSTATE_WAS_START_PRESSED    0x000008
#define E1701_CSTATE_WAS_STOP_PRESSED     0x000010
#define E1701_CSTATE_ERROR                0x000020
#define E1701_CSTATE_WAS_EXTTRIGGER       0x000040 // internal use only, do not check this flag
#define E1701_CSTATE_PROCESSING           0x000080
#define E1701_CSTATE_EMITTING             0x000100
#define E1701_CSTATE_FILE_WRITE_ERROR     0x000200
#define E1701_CSTATE_WAIT_EXTTRIGGER      0x000400
#define E1701_CSTATE_WAS_SILENTTRIGGER    0x000800 // internal use only, do not check this flag
#define E1701_CSTATE_FILEMODE_ACTIVE      0x001000 // internal use only, do not check this flag
#define E1701_CSTATE_HALTED               0x002000
#define E1701_CSTATE_WRITING_DATA         0x004000
#define E1701_CSTATE_WRITING_DATA_ERROR   0x008000
#define E1701_CSTATE_WAS_MOTION_STARTED   0x010000
#define E1701_CSTATE_WAS_MOTION_STOPPED   0x020000
#define E1701_CSTATE_IS_REFERENCING       0x040000 // not used by E1701A/D but by E1701C, defined here due to common firmware use
#define E1701_CSTATE_unused2              0x080000
#define E1701_CSTATE_WAIT_INPUT           0x100000
#define E1701_CSTATE_SAC_READY            0x200000 // in stand alone-mode only: similar to DOut0, signals "ready for marking"
#define E1701_CSTATE_SAC_MARKING          0x400000 // in stand alone-mode only: similar to DOut1, signals "marking active"
#define E1701_CSTATE_SAC_CTLXY            0x800000 // in stand alone-mode only: command ctlxy was sent and laser is on until ExtStart is released
...
#define E1701_BSTATE_CNC_BB            0x0004
#define E1701_BSTATE_LP8_EB            0x0100
#define E1701_BSTATE_DIGI_EB           0x0200
#define E1701_BSTATE_LY001_BB          0x0400

#define E1701_BSTATE_BB_MASK          (E1701_BSTATE_XY2_100_BB|E1701_BSTATE_ILDA_BB|E1701_BSTATE_LY001_BB|E1701_BSTATE_CNC_BB)
...
#define E1701_TUNE_XY3_20BIT           0x002000
...
#define E1701_TUNE_EXACT_CORRECTION    0x040000
#define E1701_TUNE_FNLSW               0x080000
...
#define E1701_PIXELMODE_HW_POWER_CONTROL   0x0004 // power control is done by hardware internally, this is currently supported for E1701_LASERMODE_MOPA only
...
extern "C"
{
   ...
   E1701_API int           E1701_set_standby(unsigned char n,double frequency,double pulse); // DEPRECATED: use E1701_set_standby2() instead!
